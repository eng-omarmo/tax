...
@section('content')
    <div class="card h-100 p-0 radius-12">
        ...
        @endif
        <form method="GET" action="{{ route('tax.rate.index') }}" id="filterForm">
            <div class="card-header border-bottom bg-base py-16 px-24 d-flex align-items-center justify-content-between flex-wrap gap-3">
                ...
                <div class="d-flex align-items-center gap-3 flex-wrap">
                    <div class="navbar-search">
                        <input type="text" class="bg-base h-40-px w-auto" name="search" placeholder="Search by Type" value="{{ request()->search }}">
                ...
                <div class="d-flex align-items-center gap-3 flex-wrap">
                    <!-- Filter Tax Rates (link to submit filter form) -->
                    ...
                    <a href="{{ route('tax.rate.create') }}" class="btn btn-primary text-sm btn-sm px-12 py-12 radius-4 d-flex align-items-center">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <span class="text-md mb-0 fw-normal text-secondary-light">{{ $taxRate->rate }}%</span>
                                </div>
                            </td>
                            <td>
                                <div class="d-flex align-items-center">
                            ...
                            <td class="text-center">
                                <div class="d-flex align-items-center gap-10 justify-content-center">
                                    <a href="{{ route('tax.rate.edit', $taxRate->id) }}" class="bg-success-focus text-success-600 bg-hover-success-200 fw-medium w-40-px h-40-px d-flex justify-content-center align-items-center rounded-circle">
                                        <iconify-icon icon="lucide:edit" class="menu-icon"></iconify-icon>
                                    </a>

                                    <a href="{{ route('tax.rate.delete', $taxRate->id) }}" class="remove-item-btn bg-danger-focus bg-hover-danger-200 text-danger-600 fw-medium w-40-px h-40-px d-flex justify-content-center align-items-center rounded-circle">
