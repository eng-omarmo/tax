                ...
                <div class="col-xxl-6 col-xl-8 col-lg-10">
                    <div class="card border">
                        <div class="card-body">
                            ...
                            <!-- Tax Rate Creation Form -->
                            <form action="{{ route('tax.rate.store') }}" method="POST">
                                @csrf
                                ...
                                <div class="mb-20">
                                    ...
                                    <input type="number" step="0.01" class="form-control radius-8" id="rate"
                                        name="rate" placeholder="Enter Tax Rate Percentage"
                                ...
                                <div class="mb-20">
                                    ...
                                    <input type="date" class="form-control radius-8" id="date"
                                        name="date"
