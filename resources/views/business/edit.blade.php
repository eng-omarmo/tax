                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('business.update', $business->id) }}" method="POST">
                                ...
                                <div class="mb-20">
                                    ...
                                    <input type="text" class="form-control radius-8" id="name" name="name" value="{{ $business->name }}"
                                ...
                                <div class="mb-20">
                                    <label for="name"
                                        class="form-label fw-semibold text-primary-light text-sm mb-8">business Phone <span
                                            class="text-danger-600">*</span></label>
                                    <input type="text" class="form-control radius-8" id="Phone" name="phone" value="{{ $business->phone }}"
                                        placeholder="Enter  Phone" value="{{ old('Phone') }}">
                                </div>
                                <div class="mb-20">
                                    <label for="name"
                                        class="form-label fw-semibold text-primary-light text-sm mb-8">business Address <span
                                            class="text-danger-600">*</span></label>
                                    <input type="text" class="form-control radius-8" id="address" name="address" value="{{ $business->address }}"
                                        placeholder="Enter Full Name" value="{{ old('name') }}">
                                </div>
