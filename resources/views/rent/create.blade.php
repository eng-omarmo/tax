                ...
                <div class="row justify-content-center">
                    <div class="col-xxl-6 col-xl-8 col-lg-10">
                        <form action="{{ route('rent.property.search') }}" method="GET" class="d-flex align-items-center">
                            ...
                            <button type="submit" class="btn btn-primary text-sm btn-medium px-4 py-2 d-flex align-items-center ms-2">
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('rent.store') }}" method="POST">
                                    ...
                                    <div class="mb-20">
                                        ...
                                        <select class="form-control radius-8 form-select" id="tenant_id" name="tenant_id" required>
                                    ...
                                    <div class="mb-20">
                                        ...
                                        <input type="date" class="form-control radius-8" id="rent_start_date" name="rent_start_date" value="{{ old('rent_start_date') }}" required>
                                    </div>
                                    ...
                                    <div class="mb-20">
                                        ...
                                        <input type="date" class="form-control radius-8" id="rent_end_date" name="rent_end_date" value="{{ old('rent_end_date') }}">
                                    </div>
