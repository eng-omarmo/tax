                    ...
                    <div class="card border">
                        <div class="card-body">
                            ...
                            <form action="{{ route('lanlord.update', $lanlord->id) }}" method="POST">
                                ...
                                <div class="mb-20">
                                    <label for="name"
                                        class="form-label fw-semibold text-primary-light text-sm mb-8">lanlord Name <span
                                            class="text-danger-600">*</span></label>
                                    <input type="text" class="form-control radius-8" id="name" name="name" value="{{ $lanlord->name }}"
                                        placeholder="Enter Full Name" value="{{ old('name') }}">
                                </div>
                                <div class="mb-20">
                                    <label for="name"
                                        class="form-label fw-semibold text-primary-light text-sm mb-8">lanlord Phone <span
                                            class="text-danger-600">*</span></label>
                                    <input type="text" class="form-control radius-8" id="Phone" name="phone" value="{{ $lanlord->phone_number }}"
