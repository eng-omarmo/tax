            ...
            <div class="property-header position-relative">
                ...
                <div class="property-overlay bg-light  p-4">
                    <div class="d-flex flex-wrap justify-content-between align-items-center">
                        ...
                        <span class="badge bg-{{ $property->status === 'active' ? 'success' : 'danger' }} fs-base px-3 py-2">
                        ...
                        <div class="card border-0 h-100 bg-light-success">
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between">
                                    <span class="text-muted text-primary-light">{{ $property->units->count() }} Units</span>
                                    <span class="text-muted text-primary-light">Registered: {{ $property->updated_at->format('M d, Y') }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-0 text-muted text-primary-light">{{ $property->landlord->address }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<style>
    ...
    .card.bg-light-primary { background-color: rgba(13,110,253,0.1); }
    .card.bg-light-success { background-color: rgba(25,135,84,0.1); }
    .card.bg-light-warning { background-color: rgba(255,193,7,0.1); }
    .card.bg-light-danger { background-color: rgba(220,53,69,0.1); }
