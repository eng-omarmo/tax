                        ...
                        @foreach ($properties as $property)
                            ...
                            <td>{{ $property->latitude }}</td> --}}
                                ...
                                <td class="text-center">
                                    <span
                                        class="{{ $property->monitoring_status == 'Approved' ? 'bg-success-focus text-success-600' : 'bg-danger-focus text-danger-600' }} border px-24 py-4 radius-4 fw-medium text-sm">
                                ...
                                <td class="text-center">
                                    <span
                                        class="{{ $property->status == 'Active' ? 'bg-success-focus text-success-600' : 'bg-danger-focus text-danger-600' }} border px-24 py-4 radius-4 fw-medium text-sm">
