            ...
            <form action="{{ route('permissions.store') }}" method="POST">
                ...
                <div class="row">
                    <div class="col-12 mb-20">
                        ...
                        <input type="text" name="name" class="form-control radius-8 @error('name') is-invalid @enderror" placeholder="Enter Permission Name (e.g., create users)" value="{{ old('name') }}" required>
                        @error('name')
