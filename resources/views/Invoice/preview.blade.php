                        ...
                        <div class="col-lg-8">
                            <div class="shadow-4 border radius-8">
                                <div class="p-20 d-flex flex-wrap justify-content-between gap-3 border-bottom">
                                    ...
                                    <div>
                                        <img src="{{ asset('assets/images/logo.png') }}" alt="image" class="mb-8" height="80" width="80">
                                ...
                                <div class="py-28 px-20">
                                    ...
                                    <div class="mt-24">
                                        ...
                                        <div class="d-flex flex-wrap justify-content-between gap-3">
                                            <div>
                                                <p class="text-sm mb-0"><span class="text-primary-light fw-semibold">generate By:</span> {{auth()->user()->name }}</p>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="pe-16">
                                                                    <span class="text-primary-light fw-semibold">{{ $data['balance'] }}</span>
                                                                </td>
                                                            </tr>
                                                            <td class="pe-64">Amount Paid:</td>
                                                            <td class="pe-16">
                                                                <span class="text-primary-light fw-semibold">{{ $data['amountPaid'] }}</span>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="pe-16 pt-4">
                                                                <span class="text-primary-light fw-semibold">{{ $data['amount'] }}</span>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                    ...
                                    <div class="mt-64">
                                        <p class="text-center text-secondary-light text-sm fw-semibold">Thank you for your Collabation!</p>
                                    </div>
