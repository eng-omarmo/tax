                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="mb-20">
                                                    ...
                                                    <input type="text" name="name" class="form-control radius-8" id="name" value="{{auth()->user()->name}}">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="mb-20">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="mb-20">
                                                    ...
                                                    <input type="email" class="form-control radius-8" id="number"  name="number" value="{{auth()->user()->phone}}">
                                                </div>
                                            </div>
                                            {{-- <div class="col-sm-6">
                                                <div class="mb-20">
